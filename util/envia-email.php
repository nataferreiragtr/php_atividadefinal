<?php
    ...
    define('GUSER', 'nataferreira2021.3@gmail.com');
    define('GPWD', 'rnffwerakmglilyq');
    ...
    function send($usuario){
       ...
       $mail->setFrom('recupera-senha@gpe.com.br', 'GPE');
    ...
    function constroiMensagem($senha){
        return  "<!DOCTYPE html>"
               . "<html lang='pt-br'>"
                ...
                . "</head>"
                . "<body>"
                    . "<h1>Recuperação de senha <strong>GPE</strong></h1>"
                    . "<div align='center'>"
    ...
    function redirect($status, $msg){
        setcookie('notify', $msg, time() + 10, "gpe/forgot-password.php", 'localhost');
        setcookie('status', $status, time() + 10, "gpe/forgot-password.php", 'localhost');
